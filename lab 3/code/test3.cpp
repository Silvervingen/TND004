...
void test3() {
#ifdef TEST_ITERATOR
    {
        ...
        // Read all words in the file into a vector  -- words are not unique
        ...
        /*****************************************************/
        {
            ...
            // Sort inorder decreasingly
            std::sort(inorder.begin(), inorder.end(), std::greater<std::string>());
            assert(V1 == inorder);
